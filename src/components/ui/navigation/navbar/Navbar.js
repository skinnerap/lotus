    ...
    return (
        <div className={classes.Navbar}>  
            ...
            <nav>
                <ul>
                    <li>
                        <NavLink className={classes.DesktopOnly} exact activeStyle={{ color: '#8d1b5a' }} to='/'>Order</NavLink>
                    </li>
                    <li>
                        <NavLink className={classes.DesktopOnly} activeStyle={{ color: '#8d1b5a' }} to='/catering'>Catering</NavLink>
                    </li>
                    <li>
                        <NavLink className={classes.DesktopOnly} activeStyle={{ color: '#8d1b5a' }} to='/values'>Our Values</NavLink>
                    </li>
                    <li>
                        <NavLink className={classes.DesktopOnly} activeStyle={{ color: '#8d1b5a' }} to='/nutrition'>Nutrition</NavLink>
                    </li>
                    <li>
